  ...
  return <section className="px-6 text-white py-[26px] bg-zinc-950">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          return <div key={index} className="bg-white text-gray-900 rounded-2xl p-6 text-center hover:transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
