...
const WhyChooseUs = () => {
  ...
  return <section className="px-6 bg-white overflow-hidden py-[31px]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          <div className="flex animate-marquee whitespace-nowrap">
            {[...features, ...features].map((feature, index) => <div key={index} className="flex-none mx-8 text-center min-w-[200px]">
