        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li><a href="#" className="hover:text-gray-900 transition-colors">Wardrobe</a></li>
              <li><a href="#" className="hover:text-gray-900 transition-colors">Kitchen</a></li>
              <li><a href="#" className="hover:text-gray-900 transition-colors">Kids</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><a href="#" className="hover:text-gray-900 transition-colors">Our Service</a></li>
          ...
          {/* Get Help */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-gray-900">Get Help</h4>
            <ul className="space-y-2 text-gray-600">
